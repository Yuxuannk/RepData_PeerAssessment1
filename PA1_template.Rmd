...
```
The mean of the total steps taken per day is `r mean`, and the median is `r median`.
...
The index of 5-minute interval which on average accross all the days contains the maximum number of steps is `r index`.
...
```
After filling in all of the missing values in the dataset, the mean of the total steps taken per day is `r mean2`, and the median is `r median2`. 
